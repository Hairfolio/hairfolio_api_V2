...
Rails.application.routes.draw do  
  ...
  namespace :api, defaults: { format: :json }, constraints: { localhost: 'api' }, path: '/' do
    scope module: :v1, constraints: ApiConstraints.new(version: 1, default: true) do
      ...
      get "/user/userposts/:id" => "users#userposts"
      get "/get_user_profile/:id" => "users#get_user_profile"
      get "/view_post_share_unique_code/:id" => "refers#view_post_share_unique_code"
      ...
      resource :wallets, only: [] do
        ...
        get :wallet_transfer_info, on: :collection
      end
  ...
  get "/v2/404" => "api/v2/errors#not_found"
  get "/v2/500" => "api/v2/errors#exception"
