...
ActiveRecord::Schema.define(version: 2019_12_11_100827) do
  ...
  create_table "active_storage_attachments", force: :cascade do |t|
    ...
    t.index ["record_type", "record_id", "name", "blob_id"], name: "active_storage_unique_attachments", unique: true
  end
  ...
  create_table "log_defaults", force: :cascade do |t|
    t.string "title"
  ...
  create_table "mobile_store_banners", force: :cascade do |t|
    t.string "name"
    t.string "banner_image"
  ...
  create_table "notes", force: :cascade do |t|
    t.text "formula_note", default: [], array: true
    t.text "simple_note", default: [], array: true
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "contact_id"
  ...
  create_table "refers", force: :cascade do |t|
    ...
    t.bigint "note_id"
    t.index ["note_id"], name: "index_refers_on_note_id"
  ...
  create_table "shared_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["note_id"], name: "index_shared_logs_on_note_id"
  end
  ...
  create_table "wallet_payment_transaction_histories", force: :cascade do |t|
    t.bigint "user_id"
    t.string "amount"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_wallet_payment_transaction_histories_on_user_id"
  end
  ...
  create_table "workplaces", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["salon_id"], name: "index_workplaces_on_salon_id"
  end
  ...
  add_foreign_key "product_galleries", "products"
  ...
  add_foreign_key "shared_logs", "notes"
  ...
  add_foreign_key "wallet_payment_transaction_histories", "users"
  add_foreign_key "wallets", "users"
  add_foreign_key "workplaces", "salons"
end
