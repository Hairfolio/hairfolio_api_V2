...
ActiveRecord::Schema.define(version: 20170111001104) do
  ...
  create_table "certificates_users", id: false, force: :cascade do |t|
    ...
    t.integer "user_id"
    t.index ["certificate_id"], name: "index_certificates_users_on_certificate_id", using: :btree
    t.index ["user_id"], name: "index_certificates_users_on_user_id", using: :btree
  end
  ...
  create_table "experiences_users", id: false, force: :cascade do |t|
    ...
    t.integer "user_id"
    t.index ["experience_id"], name: "index_experiences_users_on_experience_id", using: :btree
    t.index ["user_id"], name: "index_experiences_users_on_user_id", using: :btree
  end
