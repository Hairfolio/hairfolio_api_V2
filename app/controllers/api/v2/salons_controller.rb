class Api::V2::SalonsController < ApplicationController
  ...
  def fetch_all
    ...
    salons = salons.with_distance_to([params[:latitude], params[:longitude]]).order("distance") if params[:latitude] && params[:longitude]
